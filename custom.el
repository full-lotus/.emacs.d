...
(custom-set-faces
 ...
 '(org-level-1 ((t (:extend nil :foreground "dark violet"))))
 '(org-level-2 ((t (:extend nil :foreground "blue"))))
 '(org-level-3 ((t (:extend nil :foreground "deep sky blue"))))
 '(org-level-4 ((t (:extend nil :foreground "medium spring green"))))
 '(org-level-5 ((t (:extend nil :foreground "gold"))))
 '(org-level-6 ((t (:extend nil :foreground "orange"))))
