...
(custom-set-faces
 ...
 '(org-level-1 ((t (:extend nil :foreground "black" :weight semi-bold :height 1.5))))
 '(org-level-2 ((t (:extend nil :foreground "dark violet" :height 1.5))))
 '(org-level-3 ((t (:extend nil :foreground "medium blue"))))
 '(org-level-4 ((t (:extend nil :foreground "deep sky blue"))))
 '(org-level-5 ((t (:extend nil :foreground "forest green"))))
 '(org-level-6 ((t (:extend nil :foreground "goldenrod"))))
 '(org-level-7 ((t (:extend nil :foreground "DarkOrange1"))))
