...
(setq custom-file "~/.emacs.d/elisp/customizations-generated-by-emacs.el")
...
(custom-set-variables
 '(package-selected-packages
   '(async bm casual-avy cider clojure-mode command-log-mode
	   vertico consult orderless embark embark-consult marginalia corfu cape
